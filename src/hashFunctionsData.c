...
int lenForHF(HashFunction hashFunction)
{
	...
	//else 
	if (hashFunction == HF_SHA256) { return 256 / 8; }
	...
	if (hashFunction == HF_SHA3_256) { return 256 / 8; }
...
char* strForHF(HashFunction hashFunction)
{
	...
	//else 
		if (hashFunction == HF_SHA256) { return "sha256"; }
	...
	//else 
	if (hashFunction == HF_SHA3_256) { return "sha3-256"; }
...
const EVP_MD* pointerToOpenSSLhf(HashFunction hashFunction)
{
	...
	//else 
	if (hashFunction == HF_SHA256) { return EVP_sha256(); }
	...
	//if (hashFunction == HF_SHA3_224) { return EVP_sha3_224(); }
	//else 
	if (hashFunction == HF_SHA3_256) { return EVP_sha3_256();; }
...
HashFunction hfFromStr(char* input, int inputLen)
{
	...
	//else 
	if (!strcmp(str, "sha-256") || !strcmp(str, "sha256")) { return HF_SHA256; }
	...
	//else 
		if (!strcmp(str, "sha3-256")) { return HF_SHA3_256; }
