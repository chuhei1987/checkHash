...
void showHelp(void)
{
	puts(
		"checkHash - Help\n"
		"Usage: SHA3SUM [options] [filename] [hash / filename / filenames...]\n\n"
		"List of options:\n"
		...
		"                     Examples:\n"
		"                      SHA3SUM file1.txt\n"
		"                      SHA3SUM file1.txt file2.txt\n"
		"                      SHA3SUM file1.txt ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad\n"
		" -g                  Get the hash for each file from input.\n"
		"  (--get-hash)       Calculates a hash for each input file.\n"
		"                     Examples:\n"
		"                      SHA3SUM -g file1.txt file2.txt file3.txt\n"
		" -s [strings]        Hash of string.\n"
		"  (--string-hash)    Calculates the hash for string or strings.\n"
		"                     Examples:\n"
		"                      SHA3SUM -s \"Example string\"\n"
		"                      SHA3SUM -s \"First string\" \"Second string\"\n"
		...
		"                     Examples:\n"
		"                      SHA3SUM -cf file1.txt file2.txt\n"
		...
		"                     Examples:\n"
		"                      SHA3SUM -ch file1.txt ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad\n"
		...
		"                     Examples:\n"
		"                      SHA3SUM -f\n"
		"                      SHA3SUM -f sha3-256 file1.txt\n"
		"                      SHA3SUM -f sha3-512 -g file1.txt file2.txt\n"
		" -so                 Simple output.\n"
		"  (--simple-output)  Simplifies the output.\n"
		"                     When comparing, it gives 1 at the end when equal or 0 when different.\n"
		"                     Examples:\n"
		"                      SHA3SUM -so file1.txt file2.txt\n"
		"                      SHA3SUM -h -so file1.txt file2.txt file3.txt\n"
